...
def identificar_estrategia(texto):
    ...
    # --------------------------------------------------------
    # BTTS NO DEBE IR DESPUÉS DE BTTS GENERAL
    # --------------------------------------------------------
...
def extraer_cuota(texto):
    ...
    patrones = [
        ...
        # cuota de bet365: 1.66
        r"cuota\s+de\s+bet365\s*[:=]?\s*([0-9]+(?:[.,][0-9]+)?)",
